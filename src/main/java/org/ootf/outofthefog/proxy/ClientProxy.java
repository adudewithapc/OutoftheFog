...
import org.ootf.outofthefog.client.models.ModelVastasaurusRex;
...
public class ClientProxy implements IProxy
{
    ...
    public void preInit()
    {
        RenderingRegistry.registerEntityRenderingHandler(EntityVastatosaurusRex.class, manager -> new RenderVastasaurusRex(manager, new ModelVastasaurusRex(), 0.5f));
